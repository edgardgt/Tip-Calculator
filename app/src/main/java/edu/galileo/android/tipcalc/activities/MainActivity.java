...
public class MainActivity extends AppCompatActivity {
    @Bind(R.id.inputBill)
    EditText inputBill;
    @Bind(value = R.id.btnSubmit)
    Button btnSubmit;
    @Bind(value = R.id.inputPercentage)
    EditText inputPercentage;
    @Bind(value = R.id.btnIncrease)
    Button btnIncrease;
    @Bind(value = R.id.btnDecrease)
    Button btnDecrease;
    @Bind(value = R.id.btnClear)
    Button btnClear;
    @Bind(value = R.id.txtTip)
    TextView txtTip;
    ...
    private void hideKeyboard() {
        ...
        try {
            ...
            Log.e("", Log.getStackTraceString(npe));
        }
    }
